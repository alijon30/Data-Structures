...
class Heap:
    def __init__(self, size):
        ...
        self.customList.extend([n for n in range(1, size + 1)])
    def heapify(self, index):
        ...
        if self.customList[parent_index] > self.customList[index]:
    ...
    def Extractor(self, index):
        ...
        if self.HeapSize < left:
            ...
            if self.customList[index] > self.customList[left]:
